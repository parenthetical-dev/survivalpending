...
export default function SafetyStep({ onNext, onBack }: SafetyStepProps) {
  ...
  return (
    <>
      <CardHeader>
        <CardTitle className="text-2xl">Your Safety First</CardTitle>
        <CardDescription>
      ...
      <CardContent className="space-y-6">
        <Alert className="border-red-200 bg-red-50">
          ...
          <AlertTitle className="text-red-900 mb-2">Quick Exit</AlertTitle>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="p-4 bg-gray-50 rounded-lg space-y-2">
              <div>
                <p className="font-medium">Trans Lifeline</p>
                <p className="text-sm text-muted-foreground">Peer support by and for trans people - Available 24/7</p>
              </div>
              <div className="flex gap-3">
                <a href="tel:877-565-8860" className="inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-800">
            ...
            <div className="p-4 bg-gray-50 rounded-lg space-y-2">
              <div>
                <p className="font-medium">The Trevor Project</p>
                <p className="text-sm text-muted-foreground">Support for LGBTQ youth - Available 24/7</p>
              </div>
              <div className="flex flex-wrap gap-3">
                <a href="https://chat.trvr.org/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-800">
                  <MessageSquare className="w-4 h-4" />
                  <span className="font-medium">Chat</span>
                </a>
                <a href="tel:1-866-488-7386" className="inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-800">
                  <Phone className="w-4 h-4" />
                  <span className="font-medium">1-866-488-7386</span>
                </a>
                <a href="sms:678678" className="inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-800">
                  <MessageSquare className="w-4 h-4" />
