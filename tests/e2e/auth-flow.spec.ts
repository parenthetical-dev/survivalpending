...
test.describe('Authentication Flow', () => {
  ...
  test('signup with onboarding flow', async ({ page }) => {
    ...
    const autoGeneratedUsername = await page.locator('input#username').inputValue();
    console.log('Using auto-generated username:', autoGeneratedUsername);
    ...
    // Onboarding Step 1: Welcome - Look for the welcome message with username
    await expect(page.getByText(/Welcome,.*$/)).toBeVisible();
    await expect(page.getByText(/Your survival may be pending/)).toBeVisible();
  ...
  test('login flow', async ({ page }) => {
    ...
    // Get the auto-generated username
    const autoGeneratedUsername = await page.locator('input#username').inputValue();
    console.log('Creating user for login test:', autoGeneratedUsername);
    ...
    // Enter credentials with the auto-generated username
    await page.locator('input#username').fill(autoGeneratedUsername);
    await page.locator('input#password').fill('TestPassword123!');
